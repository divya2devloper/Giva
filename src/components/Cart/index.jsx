            ...
            <div class="grid md:grid-cols-3 gap-8 mt-16">
                    ...
                    <div class="grid grid-cols-3 items-start gap-4">
                        <div class="col-span-2 flex items-start gap-4">
                            <div class="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0 bg-gray-100 p-2 rounded-md">
                                <img src='../images/givasets.jpg' class="w-full h-full object-contain" />
                            </div>

                            <div class="flex flex-col">
                                <h3 class="text-base font-bold text-gray-800">Jwellery set</h3>
                        ...
                        <div class="ml-auto">
                            <h4 class="text-lg max-sm:text-base font-bold text-gray-800">₹15,000</h4>
                ...
                <div class="bg-gray-100 rounded-md p-4 h-max">
                    ...
                    <ul class="text-gray-800 mt-6 space-y-3">
                        <li class="flex flex-wrap gap-4 text-sm">Subtotal <span class="ml-auto font-bold">₹15,000</span></li>
                        <li class="flex flex-wrap gap-4 text-sm">Shipping <span class="ml-auto font-bold">₹100</span></li>
                        <li class="flex flex-wrap gap-4 text-sm">Tax <span class="ml-auto font-bold">₹500</span></li>
                        <hr class="border-gray-300" />
                        <li class="flex flex-wrap gap-4 text-sm font-bold">Total <span class="ml-auto">₹15,600</span></li>
                    </ul>
