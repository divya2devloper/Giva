...
const Categories = () => {
  return (<>
  <div className='flex justify-between gap-4 max-sm:hidden'>
    <Menu as="div" className="relative inline-block text-left z-50">
      <div>
        <MenuButton className="inline-flex w-full justify-center gap-x-1.5  bg-white px-3 py-2 text-sm underline hover:text-pink-700 font-semibold text-gray-900 shadow-sm  ring-gray-300 hover:bg-gray-50">
          Shop by categories
